...
import { IoIosSearch, IoMdMenu, IoMdSearch } from "react-icons/io";
...
const Navbar = () => {
  return (
    <>
      ...
      <div className='sm:flex hidden flex-row items-center justify-between py-2 w-full'>
      ...
      <div className='sm:hidden flex flex-row items-center justify-between py-4 w-full'>
        <IoMdMenu className='text-[28px] text-violet-600 ml-2' />
        <IoMdSearch className='text-[28px] text-violet-600 mr-2' />
      </div>
    </>
  )
}
